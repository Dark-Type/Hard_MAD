...
class PerfectRadialGradientView: UIView {
    // MARK: - Properties
    ...
    required init?(coder: NSCoder) {
        self.topLeftColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0)
        self.topRightColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0)
        self.bottomRightColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0)
        self.bottomLeftColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0)
    ...
    private func setupView() {
        ...
        setupGradients(in: gradientContainer.layer)
        
        addBlurEffect(to: gradientContainer)
    ...
    private func setupGradients(in containerLayer: CALayer) {
        let colors = [topLeftColor, topRightColor, bottomRightColor, bottomLeftColor]
        
        for i in 0..<4 {
            let gradientLayer = createRadialGradient(with: colors[i])
    ...
    private func positionGradientsWithRotation(angle: CGFloat, gradientSize: CGFloat) {
        ...
        for i in 0..<cornerGradients.count {
            ...
            cornerGradients[i].frame = CGRect(
    ...
    func updateColors(
        ...
        for i in 0..<min(cornerGradients.count, newColors.count) {
